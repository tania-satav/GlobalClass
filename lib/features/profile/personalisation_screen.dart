...
class _PersonalisationScreenState extends State<PersonalisationScreen> {
  ...
  void _savePreferences() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Personalisation settings saved')),
    );
  }
              ...
              _SectionCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Low = little exercise, Medium = some activity most days, High = frequent exercise or a lot of sweating.',
                      style: TextStyle(
                        fontSize: 13,
                        height: 1.4,
